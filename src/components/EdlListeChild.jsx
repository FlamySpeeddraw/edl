    ...
    return (
        <>
            <li className="li-liste-residence">
                {nbFiches > 0 ? <Link className="link-liste-residence" to={"/GC/" + residenceInfos.id + "/fiches/"}>{residenceInfos.residence} - {residenceInfos.dossier}</Link> : <Link className="link-liste-residence" to={"/GC/" + residenceInfos.id + "/edit/new"}>{residenceInfos.residence} - {residenceInfos.dossier}</Link> }
