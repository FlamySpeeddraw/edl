...
export const PieceDiag = ({onDeletePiece,infosPiece,index,onUpdatedPiece,onDeleteElement}) => {
    const handleUpdateElement = (element,updatedElement) => {
        ...
        updatedElements[infosPiece.elements.indexOf(element)].dimensions = updatedElement.dimensions;
        updatedElements[infosPiece.elements.indexOf(element)].type = updatedElement.type;
